...
using SonorisApi.Auth.Model;
using SonorisApi.Configuration;
using DbManager.Contexts;
using DbManager.Model;
using System.Security.Claims;
using System.Security.Principal;
using SonorisApi.Util;
using FirebaseApi.models;
using System.Threading.Tasks;
using SonorisApi.Controllers.MAuth.Model;
using Microsoft.AspNetCore.Authorization;
using SonorisApi.Controllers.MChannelPlaylist.Action;
